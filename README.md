...
- **Eliminato completamente il bias linguistico delle parole assolutistiche**: dopo il primo intervento (che aveva già eliminato le 49 domande "indovinabili al 100%"), restava un residuo del 37,4% di domande con almeno una risposta contenente parole come "sempre/mai/solo/esclusivamente" non bilanciate dalla risposta corretta. Tutte le 207 domande interessate sono state riscritte a mano con contenuto realmente alternativo. **Durante questo lavoro ho scoperto e corretto anche un mio errore**: alcune riscritture avevano prodotto per sbaglio due risposte identiche nella stessa domanda (42 casi) — un bug di sostituzione testuale che ho verificato e sistemato uno per uno. Risultato finale, verificato con controllo automatico: 0 domande con parole-spia sfruttabili, 0 domande duplicate, 0 opzioni duplicate all'interno di una stessa domanda, bias di lunghezza al 14,1% (in linea con il caso puro, 25% con 4 opzioni).
- **31 domande di Statistica basate sulla TUA dispensa** più altre 25 su probabilità/inferenza (56 totali), con gli stessi esempi numerici e dataset delle tue slide.
- **Revisione errori generale**: controllo automatico su tutte le domande (campi mancanti, indice della risposta corretta fuori range, difficoltà non valida) e ricerca di domande duplicate.
- **Totale: 554 domande** nella banca fissa (partite da 220).
