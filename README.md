...
- **354 nuove domande di Economia Aziendale basate sul TUO paniere d'esame**: ho estratto tutte le coppie domanda-risposta corretta dal paniere caricato (352 uniche), scritto per ciascuna 3 opzioni sbagliate plausibili, e applicato lo stesso controllo di qualità già usato per le altre materie (bilanciamento lunghezza, eliminazione parole assolutistiche come "sempre/mai/solo/esclusivamente" nelle risposte sbagliate, controllo duplicati). Trovate e corrette 48 domande completamente indovinabili al 100%, riscritte con contenuto realmente alternativo. Zero duplicati con la banca dati già esistente.
  - ⚠️ **Una nota di trasparenza**: in una domanda del paniere originale ("Nelle società di persone...") la risposta indicata come corretta ("i soci rispondono solo nei limiti della quota di capitale") contraddice il diritto societario di base (nelle società di persone i soci rispondono di norma illimitatamente e solidalmente — lo stesso paniere lo conferma altrove parlando della SNC). Ho segnato come corretta l'opzione giuridicamente esatta, ma se il tuo docente valuta letteralmente secondo la chiave originale del paniere, ti conviene verificare con lui questo punto specifico prima dell'esame.
  - Resta un 38% di domande con almeno una risposta sbagliata contenente occasionalmente queste parole (un'euristica debole, non un indizio decisivo) — se vuoi lo stesso lavoro di pulizia approfondita già fatto sulle altre materie fammelo sapere.
- **Economia Aziendale: da 88 a 442 domande** nella banca fissa.
- **Corretto il bias linguistico delle parole assolutistiche** in tutte le altre materie (vedi cronologia precedente): 0 domande sfruttabili al 100%, bias di lunghezza al 14,1%.
- **56 domande di Statistica basate sulla TUA dispensa**, copertura completa di entrambe le parti del corso.
- **Totale generale: 908 domande** nella banca fissa (partite da 220).
